...
export default function UploadWidget() {
  ...
  const handleUpload = async (e: React.MouseEvent) => {
    ...
    const settings = JSON.parse(
      localStorage.getItem("azelia-settings") || "{}",
    );
    ...
    const transcriptionSource =
      localStorage.getItem("azelia_transcription_source") || "local_whisper";
    ...
    <div
      className={cn(
        ...
        isDragging
          ...
          : "border-zinc-800 hover:border-brand-500/50 hover:bg-zinc-900/50",
      )}
          ...
          <div
            className={cn(
              ...
              isDragging
                ...
                : "bg-zinc-900 text-zinc-400 group-hover:scale-110 group-hover:text-brand-400",
            )}
          >
            <Upload size={32} />
          </div>

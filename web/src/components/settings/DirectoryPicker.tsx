...
export const DirectoryPicker: React.FC<DirectoryPickerProps> = ({ isOpen, currentPath, onSelect, onClose }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <div className="bg-zinc-900 border border-white/10 rounded-2xl w-full max-w-xl shadow-2xl flex flex-col max-h-[80vh]">
                ...
                <div className="flex items-center justify-between px-5 py-4 border-b border-white/5">
                    <h3 className="text-white font-semibold text-lg">Select Podcast Directory</h3>
                ...
                <div className="px-5 py-3 bg-black/30 border-b border-white/5 flex items-center gap-2">
                    ...
                    <code className="text-sm text-brand-400 font-mono truncate flex-1">{resolvedPath}</code>
                </div>
                ...
                <div className="flex-1 overflow-y-auto min-h-[200px] max-h-[400px]">
                    {isLoading ? (
                        ...
                        <div className="text-center py-12 text-zinc-500 text-sm">No subdirectories</div>
                    ) : (
                        <div className="py-1">
                            {dirs.map((dir) => (
                                <button
                ...
                <div className="px-5 py-4 border-t border-white/5 flex items-center justify-between">
                    <p className="text-xs text-zinc-500">Navigate to your episodes folder, then click Select</p>
                    <button
                        onClick={() => { onSelect(resolvedPath); onClose(); }}

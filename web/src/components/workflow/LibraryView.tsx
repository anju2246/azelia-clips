...
import { Play, FileText, CheckCircle2, Clock, AlertCircle, FolderOpen } from 'lucide-react';
        ...
        <div className="w-full">
            <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p className="text-zinc-500 text-sm mt-1">Episodes detected in local directory</p>
                </div>
                <button
                    onClick={loadEpisodes}
                    className="px-4 py-2 hover:bg-zinc-800 rounded-lg text-sm text-zinc-400 transition-colors border border-zinc-800"
                >
                    Refresh
                </button>
            </div>
                    ...
                    >
                        ...
                        <div className="mt-auto">
                            <button
                                ...
                                className={`w-full py-2.5 rounded-xl text-sm font-medium transition-colors ${!ep.has_video
...
// Add to imports at top if missing: import { FolderOpen } from 'lucide-react';

...
const PRESETS: Record<
  PresetId,
  { label: string; blurb: string; config: Partial<ProcessRequest> }
> = {
  quick: {
    label: "Quick",
...
export const UploadZone: React.FC<UploadZoneProps> = ({
  ...
  const handleProcess = async () => {
    ...
    const loadingToast = toast.loading(
      file
        ? "Uploading file to local engine (this may take a moment)..."
    ...
    <div className="w-full max-w-3xl mx-auto mt-10">
      <div className="text-center mb-8">
        ...
        <p className="text-zinc-400">
          Upload a single file or configure an episode from your library.
        </p>
      </div>
        ...
        {!file && !localVideoPath ? (
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm text-zinc-500 mb-6 max-w-sm">
              Support for MP4, MOV, MKV up to 5GB. Picking a local file skips
              upload delays.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setConfig({
                      ...config,
                      min_duration: parseInt(e.target.value) || 30,
                    })
                  }
                ...
                <input
                  ...
                  onChange={(e) =>
                    setConfig({
                      ...config,
                      max_duration: parseInt(e.target.value) || 90,
                    })
                  }
                  className="w-full px-3 py-2 bg-black border border-zinc-800 rounded-lg text-sm focus:outline-none focus:border-brand-500"
                  placeholder="Max"
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setConfig({ ...config, transcription_source: e.target.value })
                }
              ...
              >
                ...
                <option value="supabase_custom">
                  My Supabase (custom transcripts)
                </option>
              </select>
            </div>
          </div>

...
export const YouTubeNudge: React.FC<YouTubeNudgeProps> = ({
  connected = false,
  onConnected,
}) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-linear-to-r from-red-950/40 via-zinc-900/80 to-zinc-900/80 border border-red-500/20 p-5 mb-6 animate-in fade-in slide-in-from-top-2 duration-500">
      {/* Glow effect */}
      ...
      <div className="relative flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-zinc-400 text-xs mt-0.5 leading-relaxed">
            Sync your channel to see what's working — duration trends,
            top-performing hooks, and growth patterns.
          </p>
        </div>

        <a
          href="/dashboard/intelligence"
          className="shrink-0 flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-500 text-white text-sm font-medium rounded-lg transition-all shadow-lg shadow-red-500/20"
        >

"""Supabase integration for fetching Inminente Podcast transcripts."""
...
class SupabaseClient:
    ...
    def _parse_episodes(self, data: list[dict]) -> list[Episode]:
        ...
        for row in data:
            # Extract episode number from title (e.g., "EP108 - Title")
    ...
    def get_transcript(self, episode_id: str) -> Transcript | None:
        ...
        Args:
            episode_id: Episode ID (UUID) or episode number (e.g., EP108)
